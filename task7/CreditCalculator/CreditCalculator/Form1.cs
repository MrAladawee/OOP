namespace CreditCalculator
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            int time_Credit_M = Convert.ToInt32(dateTimePicker1.Value.ToString("MM"));      // Месяц кредитования
            ...
            form2.label7.Text = string.Format("{0} руб.", Math.Round(sum_of_payment_annuity, 2));
            form2.label4.Text = string.Format("{0} руб.", Math.Round((-Convert.ToDouble(trackBar1.Value) + sum_of_payment_annuity), 2));
